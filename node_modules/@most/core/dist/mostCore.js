(function (global, factory) {
	...
	(factory((global.mostCore = global.mostCore || {}),global.mostPrelude,global.mostScheduler,global.mostDisposable));
}(this, (function (exports,_most_prelude,_most_scheduler,_most_disposable) { 'use strict';
...
Empty.prototype.run = function run (sink, scheduler) {
  return _most_scheduler.asap(propagateEndTask(sink), scheduler)
};
...
Never.prototype.run = function run () {
  return _most_disposable.disposeNone()
};
...
At.prototype.run = function run (sink, scheduler) {
  return _most_scheduler.delay(this.time, propagateTask$1(runAt, this.value, sink), scheduler)
};
...
Periodic.prototype.run = function run (sink, scheduler) {
  return _most_scheduler.periodic(this.period, propagateEventTask$1(undefined, sink), scheduler)
};
...
var runEffects$1 = _most_prelude.curry2(function (stream, scheduler) { return new Promise(function (resolve, reject) { return runStream(stream, scheduler, resolve, reject); }); });
...
WithLocalTime.prototype.run = function run (sink, scheduler) {
  return this.source.run(relativeSink(this.origin, sink), _most_scheduler.schedulerRelativeTo(this.origin, scheduler))
};
...
Scan.prototype.run = function run (sink, scheduler) {
  var d1 = _most_scheduler.asap(propagateEventTask$1(this.value, sink), scheduler);
  var d2 = this.source.run(new ScanSink(this.f, this.value, sink), scheduler);
  return _most_disposable.disposeBoth(d1, d2)
};
...
var ContinueWithSink = (function (Pipe$$1) {
  function ContinueWithSink (f, source, sink, scheduler) {
    ...
    this.active = true;
    this.disposable = _most_disposable.disposeOnce(source.run(this, scheduler));
  }
  ...
  ContinueWithSink.prototype.end = function end (t) {
    ...
    _most_disposable.tryDispose(t, this.disposable, this.sink);
...
Map.create = function create (f, source) {
  if (source instanceof Map) {
    return new Map(_most_prelude.compose(f, source.f), source.source)
  }
...
Combine.prototype.run = function run (sink, scheduler) {
  ...
  return _most_disposable.disposeAll(disposables)
};
...
var CombineSink = (function (Pipe$$1) {
  ...
  CombineSink.prototype._dispose = function _dispose (t, index) {
    _most_disposable.tryDispose(t, this.disposables[index], this.sink);
 ...
 */
function ap$1 (fs, xs) {
  return combine$1(_most_prelude.apply, fs, xs)
}
...
var mergeConcurrently$1 = function (concurrency, stream) { return mergeMapConcurrently$1(_most_prelude.id, concurrency, stream); };
...
Outer.prototype._endInner = function _endInner (t, inner) {
  ...
  _most_disposable.tryDispose(t, inner, this);
...
var mapAndRun = function (f, t, x, sink, scheduler) { return f(x).run(sink, _most_scheduler.schedulerRelativeTo(t, scheduler)); };
 ...
 */
var mergeStreams = function (streams) { return new Merge(_most_prelude.reduce(appendSources, [], streams)); };
...
Sample.prototype.run = function run (sink, scheduler) {
  ...
  return _most_disposable.disposeBoth(samplerDisposable, sourceDisposable)
};
...
var emitZipped = function (f, t, buffers, sink) { return sink.event(t, invoke(f, _most_prelude.map(head, buffers))); };
...
Switch.prototype.run = function run (sink, scheduler) {
  ...
  return _most_disposable.disposeBoth(switchSink, this.source.run(switchSink, scheduler))
};
...
SwitchSink.prototype.dispose = function dispose () {
  return this._disposeCurrent(_most_scheduler.currentTime(this.scheduler))
};
...
var Segment = function Segment (source, min, max, outer, sink, scheduler) {
  ...
  this.outer = outer;
  this.sink = sink;
  this.disposable = source.run(this, _most_scheduler.schedulerRelativeTo(min, scheduler));
};
...
Segment.prototype._dispose = function _dispose (t) {
  _most_disposable.tryDispose(t + this.min, this.disposable, this.sink);
};
...
Until.prototype.run = function run (sink, scheduler) {
  ...
  return _most_disposable.disposeAll([min, max, disposable])
};
...
Delay.prototype.run = function run (sink, scheduler) {
  ...
  return _most_disposable.disposeBoth(delaySink, this.source.run(delaySink, scheduler))
};
...
var DelaySink = (function (Pipe$$1) {
  ...
  DelaySink.prototype.dispose = function dispose () {
    ...
    _most_scheduler.cancelAllTasks(function (task) { return task.sink === this$1.sink; }, this.scheduler);
  };

  DelaySink.prototype.event = function event (t, x) {
    _most_scheduler.delay(this.dt, propagateEventTask$1(x, this.sink), this.scheduler);
  };

  DelaySink.prototype.end = function end (t) {
    _most_scheduler.delay(this.dt, propagateEndTask(this.sink), this.scheduler);
  };
...
DebounceSink.prototype.event = function event (t, x) {
  this._clearTimer();
  this.value = x;
  this.timer = _most_scheduler.delay(this.dt, propagateEventTask$1(x, this.sink), this.scheduler);
};
 ...
 */
var fromPromise = _most_prelude.compose(awaitPromises, now);
...
var AwaitSink = function AwaitSink (sink, scheduler) {
  ...
  this._eventBound = function (x) { return this$1.sink.event(_most_scheduler.currentTime(this$1.scheduler), x); };
  this._endBound = function () { return this$1.sink.end(_most_scheduler.currentTime(this$1.scheduler)); };
  this._errorBound = function (e) { return this$1.sink.error(_most_scheduler.currentTime(this$1.scheduler), e); };
};
...
ErrorStream.prototype.run = function run (sink, scheduler) {
  return _most_scheduler.asap(propagateErrorTask$1(this.value, sink), scheduler)
};
...
var MulticastSource = function MulticastSource (source) {
  this.source = source;
  this.sinks = [];
  this.disposable = _most_disposable.disposeNone();
};
...
MulticastSource.prototype.run = function run (sink, scheduler) {
  ...
  return _most_disposable.disposeOnce(new MulticastDisposable(this, sink))
};
...
var zipArrayValues = _most_prelude.curry3(zipArrayValues$1);
var withArrayValues = _most_prelude.curry2(withArrayValues$1);

// -----------------------------------------------------------------------
// Observing

var runEffects = _most_prelude.curry2(runEffects$1);
var run = _most_prelude.curry3(run$1);

// -------------------------------------------------------

var withLocalTime = _most_prelude.curry2(withLocalTime$1);

// -------------------------------------------------------

var loop = _most_prelude.curry3(loop$1);

// -------------------------------------------------------

var scan = _most_prelude.curry3(scan$1);

// -----------------------------------------------------------------------
// Extending

var startWith = _most_prelude.curry2(startWith$1);

// -----------------------------------------------------------------------
// Transforming

var map$1 = _most_prelude.curry2(map$2);
var constant = _most_prelude.curry2(constant$1);
var tap = _most_prelude.curry2(tap$1);
var ap = _most_prelude.curry2(ap$1);

// -----------------------------------------------------------------------
// FlatMapping

var chain = _most_prelude.curry2(chain$1);
var continueWith = _most_prelude.curry2(continueWith$1);

var concatMap = _most_prelude.curry2(concatMap$1);

// -----------------------------------------------------------------------
// Concurrent merging

var mergeConcurrently = _most_prelude.curry2(mergeConcurrently$1);
var mergeMapConcurrently = _most_prelude.curry3(mergeMapConcurrently$1);

// -----------------------------------------------------------------------
// Merging

var merge = _most_prelude.curry2(merge$1);
// -----------------------------------------------------------------------
// Combining

var combine = _most_prelude.curry3(combine$1);
var combineArray = _most_prelude.curry2(combineArray$1);

// -----------------------------------------------------------------------
// Sampling

var sample = _most_prelude.curry3(sample$1);

// -----------------------------------------------------------------------
// Zipping

var zip = _most_prelude.curry3(zip$1);
var zipArray = _most_prelude.curry2(zipArray$1);

// -----------------------------------------------------------------------
// Filtering

var filter = _most_prelude.curry2(filter$1);
var skipRepeatsWith = _most_prelude.curry2(skipRepeatsWith$1);

// -----------------------------------------------------------------------
// Slicing

var take = _most_prelude.curry2(take$1);
var skip = _most_prelude.curry2(skip$1);
var slice = _most_prelude.curry3(slice$1);
var takeWhile = _most_prelude.curry2(takeWhile$1);
var skipWhile = _most_prelude.curry2(skipWhile$1);
var skipAfter = _most_prelude.curry2(skipAfter$1);

// -----------------------------------------------------------------------
// Time slicing

var until = _most_prelude.curry2(until$1);
var since = _most_prelude.curry2(since$1);
var during = _most_prelude.curry2(during$1);

// -----------------------------------------------------------------------
// Delaying

var delay$1 = _most_prelude.curry2(delay$2);

// -----------------------------------------------------------------------
// Rate limiting

var throttle = _most_prelude.curry2(throttle$1);
var debounce = _most_prelude.curry2(debounce$1);

// -----------------------------------------------------------------------
// Error handling

var recoverWith = _most_prelude.curry2(recoverWith$1);
// ----------------------------------------------------------------------
var propagateTask = _most_prelude.curry3(propagateTask$1);
var propagateEventTask = _most_prelude.curry2(propagateEventTask$1);
var propagateErrorTask = _most_prelude.curry2(propagateErrorTask$1);

exports.zipArrayValues = zipArrayValues;
...
exports.propagateEventTask = propagateEventTask;
exports.propagateErrorTask = propagateErrorTask;
